...
<body>
<div class="card">
  <h1>E_Interac Form</h1>
  <div id="errorContainer"></div>
    <form:form action="/TermProject_Bank/e_interacAction" method="post" modelAttribute="transaction">
        <table>
            <tr>
            ...
            <tr>
                ...
                <td><form:input type="name" path="toAccount" /></td>
            </tr>
             <tr>
                <td>Receiver Account Type:</td>
                <td>
                    <form:select path="toAccountType">
                        <form:option value="CHECKING">Checking</form:option>
                        <form:option value="BUSINESS">Business</form:option>
                        <form:option value="SAVINGS">Savings</form:option>
                    </form:select>
